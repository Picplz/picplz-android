...
private fun OneRowSnackbar(
    ...
    Layout(
        ...
        if (isOneLine) {
            val minContainerHeight = 48.dp.roundToPx()
            ...
            val minContainerHeight = 68.dp.roundToPx()
...
object SnackbarDefaults {
    ...
    val shape: Shape @Composable get() = RoundedCornerShape(15.dp)

    /** Default color of a snackbar. */
    val color: Color @Composable get() = Color(0xFF0E0E0F).copy(alpha = 0.8f)

    /** Default content color of a snackbar. */
    val contentColor: Color @Composable get() = MainThemeColor.White

    /** Default action color of a snackbar. */
    val actionColor: Color @Composable get() = MainThemeColor.Black

    /** Default action content color of a snackbar. */
    val actionContentColor: Color @Composable get() = MainThemeColor.Black

    /** Default dismiss action content color of a snackbar. */
    val dismissActionContentColor: Color @Composable get() = MainThemeColor.Black
}
