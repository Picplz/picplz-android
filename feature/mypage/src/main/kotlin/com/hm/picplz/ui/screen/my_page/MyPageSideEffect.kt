...
sealed interface MyPageSideEffect {
    ...
    data class NavigateToPackageEdit(val photographerId: Int) : MyPageSideEffect

    data class NavigateToPhotographerActiveAreaEdit(val photographerId: Int) : MyPageSideEffect
